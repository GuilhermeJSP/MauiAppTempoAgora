       ...
       /* */private async void Button_Clicked_Localizacao(object sender, EventArgs e)
        {
            ...
            {
                await DisplayAlert("Erro: Dispositivo não Suporta Localização", fnsEx.Message, "OK");
            }
            ...
            {
                await DisplayAlert("Erro: Permissão de Localização Desabilitada", pEx.Message, "OK");
            }
            catch (Exception ex)
            {
